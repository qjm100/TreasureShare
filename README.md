...
![用户登录](screenshots/user-login.png)

**发现页** — 商品浏览、分类筛选、搜索

![发现页](screenshots/user-discovery.png)

**商品详情** — 商品信息、租期选择、加入购物车

![商品详情](screenshots/user-product-detail.png)

**购物车** — 管理待租商品，调整租期

![购物车](screenshots/user-cart.png)

**订单列表** — 查看所有订单，按状态筛选

![订单列表](screenshots/user-orders.png)

**订单详情** — 订单状态、物流信息、支付/归还操作

![订单详情](screenshots/user-order-detail.png)

**我的出租** — 卖家发货、确认归还、消毒完成

![我的出租](screenshots/user-rented-out.png)

**社区** — 发布/浏览帖子、点赞、评论

![社区](screenshots/user-community.png)

**消息** — 实时聊天、会话列表、用户搜索

![消息](screenshots/user-messages.png)
...
![管理后台登录](screenshots/admin-login.png)
...
![商品管理](screenshots/admin-products.png)

**分类管理** — 商品分类树维护

![分类管理](screenshots/admin-categories.png)

**社区管理** — 帖子/评论管理

![社区管理](screenshots/admin-community.png)
